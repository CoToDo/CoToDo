 ...
 */
class Version20180502100002 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__notification AS SELECT id, user_id, date, show, link, type FROM notification');
        ...
        $this->addSql('INSERT INTO notification (id, user_id, date, show, link, type) SELECT id, user_id, date, show, link, type FROM __temp__notification');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__notification AS SELECT id, user_id, date, show, link, type FROM notification');
        $this->addSql('DROP TABLE notification');
        $this->addSql('CREATE TABLE notification (id INTEGER NOT NULL, user_id INTEGER NOT NULL, date DATETIME NOT NULL, show BOOLEAN NOT NULL, link VARCHAR(255) NOT NULL, type VARCHAR(9) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO notification (id, user_id, date, show, link, type) SELECT id, user_id, date, show, link, type FROM __temp__notification');
        $this->addSql('DROP TABLE __temp__notification');
        $this->addSql('CREATE INDEX IDX_BF5476CAA76ED395 ON notification (user_id)');
        $this->addSql('DROP INDEX IDX_2FB3D0EE512E9BCC');
