 ...
 */
class Version20190120202721 extends AbstractMigration
{
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE auto_sync (id INTEGER NOT NULL, user_id INTEGER DEFAULT NULL, auto_allowed BOOLEAN DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_1F082576A76ED395 ON auto_sync (user_id)');
        $this->addSql('DROP INDEX IDX_9474526C8DB60186');
        $this->addSql('DROP INDEX IDX_9474526CA76ED395');
        $this->addSql('CREATE TEMPORARY TABLE __temp__comment AS SELECT id, task_id, user_id, text, date FROM comment');
        $this->addSql('DROP TABLE comment');
