 ...
 */
class Version20180415192634 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE app_users (id INTEGER NOT NULL, name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, mail VARCHAR(255) NOT NULL, hash VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_C2502824D1B862B8 ON app_users (hash)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__task AS SELECT id, name, priority, create_date, completion_date, deadline FROM task');
        $this->addSql('DROP TABLE task');
        $this->addSql('CREATE TABLE task (id INTEGER NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, priority VARCHAR(2) NOT NULL COLLATE BINARY, create_date DATETIME NOT NULL, deadline DATETIME NOT NULL, completion_date DATETIME DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO task (id, name, priority, create_date, completion_date, deadline) SELECT id, name, priority, create_date, completion_date, deadline FROM __temp__task');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE user (id INTEGER NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, last_name VARCHAR(255) NOT NULL COLLATE BINARY, mail VARCHAR(255) NOT NULL COLLATE BINARY, hash VARCHAR(255) NOT NULL COLLATE BINARY, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__comment AS SELECT id, task_id, user_id, text, date FROM comment');
        $this->addSql('DROP TABLE comment');
        $this->addSql('CREATE TABLE comment (id INTEGER NOT NULL, user_id INTEGER DEFAULT NULL, task_id INTEGER DEFAULT NULL, text VARCHAR(255) NOT NULL, date DATETIME NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_9474526CA76ED395 FOREIGN KEY (user_id) REFERENCES app_users (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO comment (id, task_id, user_id, text, date) SELECT id, task_id, user_id, text, date FROM __temp__comment');
        $this->addSql('DROP TABLE __temp__comment');
        $this->addSql('CREATE INDEX IDX_9474526C8DB60186 ON comment (task_id)');
        $this->addSql('CREATE INDEX IDX_9474526CA76ED395 ON comment (user_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__role AS SELECT id, team_id, user_id, type FROM role');
        $this->addSql('DROP TABLE role');
        $this->addSql('CREATE TABLE role (id INTEGER NOT NULL, user_id INTEGER DEFAULT NULL, team_id INTEGER DEFAULT NULL, type VARCHAR(6) NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_57698A6AA76ED395 FOREIGN KEY (user_id) REFERENCES app_users (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO role (id, team_id, user_id, type) SELECT id, team_id, user_id, type FROM __temp__role');
        $this->addSql('DROP TABLE __temp__role');
        $this->addSql('CREATE INDEX IDX_57698A6A296CD8AE ON role (team_id)');
        $this->addSql('CREATE INDEX IDX_57698A6AA76ED395 ON role (user_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__task AS SELECT id, name, priority, create_date, completion_date, deadline FROM task');
        $this->addSql('DROP TABLE task');
        $this->addSql('CREATE TABLE task (id INTEGER NOT NULL, name VARCHAR(255) NOT NULL, priority VARCHAR(2) NOT NULL, create_date DATETIME NOT NULL, deadline DATETIME NOT NULL, completion_date DATETIME NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO task (id, name, priority, create_date, completion_date, deadline) SELECT id, name, priority, create_date, completion_date, deadline FROM __temp__task');
        $this->addSql('DROP TABLE __temp__task');
        $this->addSql('DROP INDEX IDX_534E68808DB60186');
        $this->addSql('DROP INDEX IDX_534E6880A76ED395');
        $this->addSql('CREATE TEMPORARY TABLE __temp__work AS SELECT id, task_id, user_id, description, start_date, end_date FROM work');
        $this->addSql('DROP TABLE work');
        $this->addSql('CREATE TABLE work (id INTEGER NOT NULL, user_id INTEGER DEFAULT NULL, task_id INTEGER DEFAULT NULL, description VARCHAR(255) NOT NULL, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_534E6880A76ED395 FOREIGN KEY (user_id) REFERENCES app_users (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO work (id, task_id, user_id, description, start_date, end_date) SELECT id, task_id, user_id, description, start_date, end_date FROM __temp__work');
        $this->addSql('DROP TABLE __temp__work');
        $this->addSql('CREATE INDEX IDX_534E68808DB60186 ON work (task_id)');
        $this->addSql('CREATE INDEX IDX_534E6880A76ED395 ON work (user_id)');
