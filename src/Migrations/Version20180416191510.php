 ...
 */
class Version20180416191510 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__task AS SELECT id, name, priority, create_date, deadline, completion_date FROM task');
        $this->addSql('DROP TABLE task');
        $this->addSql('CREATE TABLE task (id INTEGER NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, priority VARCHAR(2) NOT NULL COLLATE BINARY, create_date DATETIME NOT NULL, completion_date DATETIME DEFAULT NULL, deadline DATE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO task (id, name, priority, create_date, deadline, completion_date) SELECT id, name, priority, create_date, deadline, completion_date FROM __temp__task');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE task');
        $this->addSql('CREATE TABLE task (id INTEGER NOT NULL, name VARCHAR(255) NOT NULL, priority VARCHAR(2) NOT NULL, create_date DATETIME NOT NULL, completion_date DATETIME DEFAULT NULL, deadline DATETIME NOT NULL, PRIMARY KEY(id))');
