 ...
 */
class Version20180416193813 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX UNIQ_C2502824D1B862B8');
        $this->addSql('CREATE TEMPORARY TABLE __temp__app_users AS SELECT id, name, last_name, mail, hash FROM app_users');
        $this->addSql('DROP TABLE app_users');
        $this->addSql('CREATE TABLE app_users (id INTEGER NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, last_name VARCHAR(255) NOT NULL COLLATE BINARY, mail VARCHAR(255) NOT NULL COLLATE BINARY, password VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO app_users (id, name, last_name, mail, password) SELECT id, name, last_name, mail, hash FROM __temp__app_users');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE app_users');
        $this->addSql('CREATE TABLE app_users (id INTEGER NOT NULL, name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, mail VARCHAR(255) NOT NULL, hash VARCHAR(255) NOT NULL COLLATE BINARY, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO app_users (id, name, last_name, mail, hash) SELECT id, name, last_name, mail, password FROM __temp__app_users');
        $this->addSql('DROP TABLE __temp__app_users');
