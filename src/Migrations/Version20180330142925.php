 ...
 */
class Version20180330142925 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__team AS SELECT id, user_id, leader_id, team_name FROM team');
        $this->addSql('DROP TABLE team');
        $this->addSql('CREATE TABLE team (id INTEGER NOT NULL, user_id INTEGER DEFAULT NULL, leader_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_C4E0A61FA76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_C4E0A61F73154ED4 FOREIGN KEY (leader_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO team (id, user_id, leader_id, name) SELECT id, user_id, leader_id, team_name FROM __temp__team');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE team');
        $this->addSql('CREATE TABLE team (id INTEGER NOT NULL, user_id INTEGER DEFAULT NULL, leader_id INTEGER DEFAULT NULL, team_name VARCHAR(255) NOT NULL COLLATE BINARY, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO team (id, user_id, leader_id, team_name) SELECT id, user_id, leader_id, name FROM __temp__team');
        $this->addSql('DROP TABLE __temp__team');
        $this->addSql('CREATE INDEX IDX_C4E0A61FA76ED395 ON team (user_id)');
        $this->addSql('CREATE INDEX IDX_C4E0A61F73154ED4 ON team (leader_id)');
        $this->addSql('DROP INDEX IDX_534E68808DB60186');
